...
node skills/uidiff/scripts/capture.mjs shoot --url http://localhost:3000/settings \
  --selector '[data-testid="save"]' --text "Save changes" --out after.png

# full page / viewport
node skills/uidiff/scripts/capture.mjs shoot --url https://app.example.com/settings --full --out before.png

# one labeled BEFORE/AFTER composite
node skills/uidiff/scripts/capture.mjs stitch --before before.png --after after.png --out combined.png
```
